 ...
 * @author Lucie Matusova <xmatus21@stud.fit.vutbr.cz>
 ...
 We use the WBSlaveInput class to wrap concrete method invocations and use these as
 alphabet symbols for the learning algorithm
 */
public class WBSlaveInput {
    ...
    public WBSlaveInput(Method action, Object[] data) {
        this.action = action;
        this.data = data;
    }
